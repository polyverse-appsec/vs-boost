...
import { CodelensProvider } from "../inline/CodelensProvider";
...
export class BoostExtension {
    ...
    public codeLensProvider: CodelensProvider | undefined;
    ...
    constructor(context: vscode.ExtensionContext) {
        ...
        try {
            ...
            this.registerInlineProviders(context);
...
*/
    ...
    registerInlineProviders(context: vscode.ExtensionContext){
        ...
        function updateDecorations() {
            ...
            const eolDecoration: vscode.DecorationOptions[] = [];
