...
export const complianceFunctionKernelName = 'compliance_function';
export const complianceFunctionOutputType = 'complianceList';

//set a helper variable of the base url.  this should eventually be a config setting
export class BoostComplianceFunctionKernel extends KernelControllerBase {

    private _complianceIssueCollection: DiagnosticCollection;
	...
	constructor(context: ExtensionContext, onServiceErrorHandler: any, otherThis: any, collection: DiagnosticCollection) {
        ...
        this._complianceIssueCollection = vscode.languages.createDiagnosticCollection(boostnb.NOTEBOOK_TYPE + '.compliance');
	}
    ...
    onKernelProcessResponseDetails(response: any, cell : vscode.NotebookCell | boostnb.BoostNotebookCell, notebook: vscode.NotebookDocument | boostnb.BoostNotebook, mimetype : any) : any {
        ...
        //now add the bugs to the compliance issue collection
